...
use Ergonode\ExporterShopware6\Infrastructure\Processor\Process\ProductRelationAttributeRemoveExportProcess;
use Webmozart\Assert\Assert;

class ProductRelationAttributeRemoveExportCommandHandler
{
    private ExportRepositoryInterface $exportRepository;

    private ChannelRepositoryInterface $channelRepository;

    private ProductRelationAttributeRemoveExportProcess $process;

    public function __construct(
        ExportRepositoryInterface $exportRepository,
        ChannelRepositoryInterface $channelRepository,
        ProductRelationAttributeRemoveExportProcess $process
    ) {
